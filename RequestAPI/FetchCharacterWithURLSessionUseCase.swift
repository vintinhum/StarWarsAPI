//
//  FetchCharacterWithURLSessionUseCase.swift
//  RequestAPI
//
...
class FetchCharacterWithURLSessionUseCase {
    
    // MARK: - ALIASES
    
    typealias UseCaseEventType = Result<Character, FetchCharacterDataUseCaseError>
...
extension FetchCharacterWithURLSessionUseCase: FetchCharacterWithURLSessionUseCaseProtocol {
